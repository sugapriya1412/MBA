...
{	
	...
	@Query(value="select COURSE_CATALOG_COURSE_ID, COURSE_CODE, COURSE_TITLE, CRSTYPCMPNTMASTER_COURSE_TYPE, "+
					...
					"STDNTSLGNDTLS_REGISTER_NUMBER in (?1) and COURSE_CODE not in (?2) and "+
	...
	@Query(value="select COURSE_CATALOG_COURSE_ID, COURSE_CODE, COURSE_TITLE, CRSTYPCMPNTMASTER_COURSE_TYPE, "+
					"to_char(EXAM_MONTH,'DD-MON-YYYY') as exam_date from academics.STUDENT_HISTORY where "+
					"STDNTSLGNDTLS_REGISTER_NUMBER in (?1) and COURSE_CODE not in (?2) and GRADE in ('Fail','F','N','N1','N2','N3','N4') "+
	...
	@Query(value="select COURSE_CATALOG_COURSE_ID, COURSE_CODE, COURSE_TITLE, CRSTYPCMPNTMASTER_COURSE_TYPE, "+
					"to_char(EXAM_MONTH,'DD-MON-YYYY') as exam_date from academics.STUDENT_HISTORY where "+
					"STDNTSLGNDTLS_REGISTER_NUMBER in (?1) and COURSE_CODE not in (?2) and GRADE "+
	...
	@Query(value="select COURSE_CATALOG_COURSE_ID, COURSE_CODE, COURSE_TITLE, CRSTYPCMPNTMASTER_COURSE_TYPE, "+
					...
					"in ('Fail','F','N','N1','N2','N3','N4') and CRSTYPCMPNTMASTER_COURSE_TYPE "+
					"not in ('ETH','ELA','EPJ','PJT','SS','OC','ECA') and COURSE_CODE not in "+
					"(select distinct COURSE_CODE from academics.STUDENT_HISTORY where STDNTSLGNDTLS_REGISTER_NUMBER in (?1) "+
